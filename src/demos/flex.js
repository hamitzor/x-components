...
const Demo = () => {
   const [direction, setDirection] = useState('row'),
      [wrap, setWrap] = useState('nowrap'),
      [justify, setJustify] = useState('start'),
      [alignItems, setAlignItems] = useState('stretch'),
      [alignContent, setAlignContent] = useState('stretch'),
      [xs, setXs] = useState(1),
      [sm, setSm] = useState(1),
      [md, setMd] = useState(1),
      [lg, setLg] = useState(1),
      [xl, setXl] = useState(1),
      [xxl, setXxl] = useState(1),
      boxStyle = {
